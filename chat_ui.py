# # streamlit_app.py - Streamlit Frontend for LLaMA-2 Personality Chatbot
# import os
# import requests
...
#     st.session_state.view = "login"  # Options: login, register, chat, profile, mbti_test

# # MBTI Test function
# def mbti_test():
#     st.title("MBTI Personality Test")
    
#     # Simple MBTI test questions (simplified for demonstration)
#     questions = [
#         {"id": 1, "text": "You prefer spending time with others rather than alone", "dimension": "E-I"},
#         {"id": 2, "text": "You focus more on details than the big picture", "dimension": "S-N"},
#         {"id": 3, "text": "You make decisions based on logic rather than feelings", "dimension": "T-F"},
#         {"id": 4, "text": "You prefer having a plan rather than being spontaneous", "dimension": "J-P"}
#     ]
    
#     # Initialize results if not already in session state
...
#     problem_statement = st.text_area("What's your main concern or problem you'd like help with? (optional)")
    
#     if st.button("Submit Results"):
#         # Determine MBTI type
#         mbti_type = ""
#         mbti_type += "E" if st.session_state.mbti_results["E"] >= st.session_state.mbti_results["I"] else "I"
#         mbti_type += "S" if st.session_state.mbti_results["S"] >= st.session_state.mbti_results["N"] else "N"
#         mbti_type += "T" if st.session_state.mbti_results["T"] >= st.session_state.mbti_results["F"] else "F"
...
#     with col1:
#         if st.button("Login") and st.session_state.user and password:
#             try:
